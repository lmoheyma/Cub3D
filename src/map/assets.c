...
/*   Updated: 2024/02/14 14:18:59 by lmoheyma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		char **lines_of_files)
{
	if (ft_strncmp(s, "NO", 2) == 0)
		...
		update_color_link(&vars->assets->f_link, asset_case, vars, lines_of_files);
	else if (ft_strncmp(s, "C", 1) == 0)
		update_color_link(&vars->assets->c_link, asset_case, vars, lines_of_files);
}
